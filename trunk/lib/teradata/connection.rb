#
# $Id: connection.rb 15 2011-01-17 11:35:05Z tdaoki $
#
...
module Teradata
  ...
  class FieldType
    ...
    def FieldType.create(code, len, name, format, title, extractor)
      ...
      raise MetaDataFormatError, "unknown type code: #{code}" unless type_name
  ...
  class FixStringType < FieldType
    ...
    bind_code :GRAPHIC_NN, 468
    bind_code :GRAPHIC_N, 469
  ...
  class VarStringType < FieldType
    ...
    bind_code :VARGRAPHIC_NN, 464
    bind_code :VARGRAPHIC_N, 465
    bind_code :LONG_VARCHAR_NN, 456
    bind_code :LONG_VARCHAR_N, 457
    bind_code :LONG_VARBYTE_NN, 696
    bind_code :LONG_VARBYTE_N, 697
    bind_code :LONG_VARGRAPHIC_NN, 472
    bind_code :LONG_VARGRAPHIC_N, 473
  ...
  class DecimalType < FieldType
    ...
    def insert_fp(str, frac)
      if frac == 0
        ...
        return "0.%0#{frac}d" % str if frac >= str.size
        str[-frac, 0] = '.'
        str
      end
    end
