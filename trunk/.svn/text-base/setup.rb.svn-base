...
module FileOperations
  ...
  def mkdir_p(dirname, prefix = nil)
    dirname = add_prefix(prefix, dirname)
  ...
  def add_prefix(prefix, path)
    ...
    prefix + remove_drive(File.expand_path(path))
  end
  ...
  def install(from, dest, mode, prefix = nil)
    ...
    realdest = add_prefix(prefix, dest)
...
class Installer
  ...
  def extconf
    # Current mkmf does not support space characters in srcdir,
    # disable srcdir build.
    #ruby "#{curr_srcdir()}/extconf.rb", *@config.config_opt
    ruby "extconf.rb", *@config.config_opt
  end
